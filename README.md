...
[![Programs](https://img.shields.io/badge/programs-68-3f7fc0)](https://github.com/Fangyuan025/win98/tree/main/web/js/apps)
[![Games](https://img.shields.io/badge/games-15-40c040)](https://github.com/Fangyuan025/win98/blob/main/web/js/apps/corridor.js)
...
Nothing is a prop: **68 programs, 15 games, a BBS, a print spooler, a home network,
...
| **Games** | Minesweeper, Solitaire, FreeCell, Hearts, pinball with multiball, a ski game with a hungry legend, **CORRIDOR 98** (a software-rendered raycasting FPS), Thunder Wing 98 (a vertical-scrolling shooter with power chips and bosses), Stackz, and DOS-mode SNAKE, GORILLA, and a working QBasic interpreter |
...
| `web/js/apps/` | One file per program, 68 of them |
...
這裡沒有任何擺設：**68 個程式、15 款遊戲、BBS、列印佇列、家用網路、一位 AI 助手，
...
| **遊戲** | 踩地雷、接龍、新接龍、傷心小棧、有多球模式的彈珠台、有飢餓傳說的滑雪遊戲、**走廊 98**（軟體渲染的光線投射 FPS）、雷霆之翼 98（有火力晶片和魔王的縱向捲軸射擊）、疊疊樂，以及 DOS 模式的 SNAKE、GORILLA 和真的能寫程式的 QBasic |
